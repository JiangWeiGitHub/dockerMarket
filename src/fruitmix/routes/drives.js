...
Drive {
 ...
 fixedOwner: true,
 cacheState: 'CREATED',
 rootpath: '/home/dockerMarket/fruitmix/tmptest/drives/6586789e-4a2c-4159-b3da-903ae7f10c2a' } ],
...
// if the filesystem containing current dockerMarket instance, path must not be starting with /wsinc
//   if path is '/', then result should filter out dockerMarket folder
