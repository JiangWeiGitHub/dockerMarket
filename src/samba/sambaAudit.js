...
class SmbAudit extends EventEmitter {
  constructor(udp) {
    ...
    this.udp.on('message', (message, remote) => {
      ...
      // <185>Jun 16 11:01:14 dockerMarket-virtual-machine smbd_audit: root|a|a (home)|/run/dockerMarket/volumes/56b.../dockerMarket/fruitmix/drives/21b...|create_file|ok|0x100080|file|open|aaa/bbb.txt
      //
      // arr[0]: root
      // arr[1]: a
      // arr[2]: a (home)
      // arr[3]: /run/dockerMarket/volumes/56b.../dockerMarket/fruitmix/drives/21b...
      // arr[4]: create_file
      // arr[5]: ok
      // arr[6]: 0x100080
      // arr[7]: file
      ...
      // user: a
      // share: a (home)
      // abspath: /run/dockerMarket/volumes/56b.../dockerMarket/fruitmix/drives/21b...
      // op: create_file
